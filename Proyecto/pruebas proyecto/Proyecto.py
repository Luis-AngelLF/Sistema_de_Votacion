...
def BusquedaClientes():
    ...
    try:
        ...
        cursor = db.cursor()
        cursor.execute("SELECT id_usuario, cedula, nombre, apellido1, apellido2, rol FROM usuarios WHERE cedula=%s", (ced,))
...
def mostrar_candidatos():
    ...
    try:
        ...
        for candidato in candidatos:
            print(f"ID Candidato: {candidato[0]}, Nombre: {candidato[1]}, 1er apellido: {candidato[2]}, 2do apellido: {candidato[3]}")
    except Exception as ex:
...
def votar():
    ...
    try:
        ...
        print(f"El usuario {datos_usuario[0][2]} ha votado correctamente.")
        print("------------------------------")
